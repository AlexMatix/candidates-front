...
export class NavbarComponent implements OnInit {
    ...
    powerOff() {
        ...
        if (status === ACTIVE_SYSTEM) {
            ...
            text = 'Si apagas el sistema nadie podrá usarlo hasta que lo prendas nuevamente';
        } else {
            title = 'Prender sistema';
            text = 'Si prendes el sistema todos los usuarios podrán ingresar';
        }
    ...
    callbackPowerOff() {
        ...
        this._power.powerON_OFF().subscribe(
            response => {
                ...
                MessagesUtil.successMessage('Éxito', text);
            },
